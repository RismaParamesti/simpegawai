...
const attendanceWarningRulesRoutes = require("./controllers/attendanceWarningRules");
const publicAttendanceWarningRulesRoutes = require("./controllers/publicAttendanceWarningRules");
...
app.use("/api/attendance-warning-rules", attendanceWarningRulesRoutes);
app.use("/api/public/attendance-warning-rules", publicAttendanceWarningRulesRoutes);
