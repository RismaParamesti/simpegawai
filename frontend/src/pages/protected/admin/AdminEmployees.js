...
function AdminEmployees() {
  ...
  const filteredPositions = useMemo(() => {
    ...
    return positions.filter(
      (position) => position.department_name === createForm.department_name,
    );
  ...
  const editFilteredPositions = useMemo(() => {
    ...
    return positions.filter(
      (position) =>
        position.department_name === editingEmployee.department_name,
    );
  ...
  const userRolesById = useMemo(() => {
    return users.reduce((accumulator, user) => {
      accumulator[String(user.id)] = Array.isArray(user.roles)
        ? user.roles
        : [];
      return accumulator;
    }, {});
  ...
  const filteredEmployees = useMemo(() => {
    ...
    return employees.filter((employee) => {
      const employeeStatus = String(employee.employment_status || "")
        .toLowerCase()
        .trim();
      ...
      if (createdStaff?.employee_id && hasSelectedDocuments(createDocuments)) {
        ...
        if (createDocuments.diploma_document) {
          documentFormData.append(
            "diploma_document",
            createDocuments.diploma_document,
          );
        }
  ...
  const mapEmployeeToEditForm = useCallback(
    (employee) => {
      const rolesFromEmployee = Array.isArray(employee.roles)
        ? employee.roles
        : [];
  ...
  }, [employees, location.state?.employeeId, mapEmployeeToEditForm]);
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      if (hasNewDocument) {
        ...
        formData.append(
          "full_name",
          editingEmployee.name || editingEmployee.full_name || "",
        );
  ...
  return (
    <>
      ...
      >
        <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-1 xl:grid-cols-5">
          <label className="form-control w-full xl:col-span-2">
            <span className="label-text mb-1 text-sm font-medium text-base-content/70">
              Cari Nama / Kode Employee
            </span>

            <input
              type="search"
              className="input input-bordered w-full"
              placeholder="Cari nama atau kode employee"
          ...
          <form className="space-y-4 mt-4" onSubmit={handleCreateEmployee}>
            ...
            <div className="border border-base-300 rounded-lg p-4">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
                ...
                <div className="relative">
                  <span className="absolute -top-2 left-3 bg-base-100 px-1 text-xs text-base-content/70">
                    Tanggal Lahir
                  </span>
                  <input
                    className="input input-bordered w-full"
            ...
            <div className="border border-base-300 rounded-lg p-4">
              ...
              <p className="text-xs text-base-content/70 mb-2">
                ...
                Perubahan role dilakukan oleh Admin pada halaman manajemen
                pengguna.
              </p>
              ...
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-2 w-full">
                  ...
                  <div>
                    ...
                    {getDisplayValue(viewingEmployee.user_status)}
                  </div>
                </div>
              </div>
          ...
          {editingEmployee ? (
            <div className="space-y-4 mt-4">
              ...
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-3">
                  ...
                  <p className="text-xs text-base-content/70 md:col-span-2">
                    Gaji pokok ditentukan otomatis berdasarkan posisi dan tidak
                    dapat diubah manual.
                  </p>
                </div>
              </div>
              ...
              <div className="border border-base-300 rounded-lg p-4">
                <p className="font-semibold mb-3">Role & Hak Akses</p>
                <p className="text-xs text-base-content/70 mb-2">
                  Role otomatis berubah sesuai departemen dan posisi yang
                  dipilih (preview langsung).
                </p>
                <div className="flex flex-wrap gap-2">
